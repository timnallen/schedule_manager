...
describe Appointment do
  ...
  describe 'instance methods' do
    it 'validity_test' do
      ...
      app_5 = Appointment.new(schedule: schedule, start_time: nil, end_time: nil)
      ...
      expect(app_5.validity_test).to eq(valid: false, message: "Start and end time must be given")
